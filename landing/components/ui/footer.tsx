      ...
      <div className="py-12 md:py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className={"flex flex-row justify-center"}>
            <div id={"contacts"}>
              <p className={"my-1 text-xl"}>Будем рады сотрудничеству</p>
              <p className={"text-base text-center italic"}>Tradecampcompany@gmail.com</p>
            </div>
          </div>
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            {/* Copyrights note */}
            <div className="text-gray-400 text-sm mr-4">&copy; TradeCamp. All rights reserved.</div>
