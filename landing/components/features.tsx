            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                <div className="py-12 md:py-20">
                    ...
                    <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
                        <h2 className="h2 mb-4">Сервис привлечет новых трейдеров и инвесторов на фондовый рынок.</h2>
                        <p className="text-xl text-gray-400">После тренировки трейдер чувствует себя увереннее и может
                            приносить больше денег банку и брокеру.</p>
                    </div>
                    ...
                    <div
                        ...
                        <div className="relative flex flex-col items-center" data-aos="fade-up"
                            ...
                            <h4 className="h4 mb-2">Виртуальные деньги</h4>
                            <p className="text-lg text-gray-400 text-center">Виртуальные деньги позволяют мониторить
                                свой виртуальный капитал</p>
                        </div>
                        ...
                        <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="100"
                            ...
                            <h4 className="h4 mb-2">Игровая форма</h4>
                            <p className="text-lg text-gray-400 text-center">Сервис спроектирован в форме сопернической
                                игры</p>
                        </div>
                        ...
                        <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="200"
                            ...
                            <h4 className="h4 mb-2">Рейтинг</h4>
                            <p className="text-lg text-gray-400 text-center">Предусмотрена рейтингова система, в которой
                                будут отображаться лучшие виртуальные трейдеры</p>
                        </div>
                        ...
                        <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="300"
                            ...
                            <h4 className="h4 mb-2">Нейронные связи</h4>
                            <p className="text-lg text-gray-400 text-center">В ходе тренировки у трейдера формируются
                                нейронные связи в принятии быстрых решений</p>
                        </div>
                        ...
                        <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="400"
                            ...
                            <h4 className="h4 mb-2">Премиум</h4>
                            <p className="text-lg text-gray-400 text-center">Предусмотрены премиум аккаунты, которые
                                помогут стартапу быстрее выйти в прибыль</p>
                        </div>
                        ...
                        <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="500"
                            ...
                            <h4 className="h4 mb-2">Партнерство</h4>
                            <p className="text-lg text-gray-400 text-center">Ссылки на партнеров принесут больше
                                клиентов банкам и брокерам.</p>
                        </div>
