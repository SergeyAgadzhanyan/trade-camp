      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <div className="inline-flex text-sm font-semibold py-1 px-3 m-2 text-green-600 bg-green-200 rounded-full mb-4">Почему мы?</div>
            <h1 className="h2 mb-4">Сформированная команда разработчиков с продуктом на стадии бета тестирования</h1>
          </div>
          ...
          <div className="grid gap-20">
            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-5 lg:col-span-6 mb-8 md:mb-0 md:order-1" data-aos="fade-up">
                <Image className="max-w-full mx-auto md:max-w-none h-auto" src={Mobile3} width={540} height={405} alt="Features 01" />
              </div>
              {/* Content */}
